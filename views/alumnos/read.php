        ...
        <div class="w-5/6 flex flex-col">
                    ...
                    <table class="border-collapse border border-slate-500 w-full">
                        <thead>
                            <tr>
                                ...
                                <th class="border border-slate-600 text-left pl-4">DNI</th>
                                <th class="border border-slate-600 text-left pl-4">Nombre</th>
                                <th class="border border-slate-600 text-left pl-4">Correo</th>
            ...
            ?>
                <tr class="bg-white odd:bg-[#F2F2F2] ">
                    <td class="border border-slate-400 pl-4 py-2"><?= $alumno["id"] ?></td>
                    <td class="border border-slate-400 pl-4"><?= $alumno["dni"] ?></td>
                    <td class="border border-slate-400 pl-4"><?= $alumno["name"] ?></td>
                    <td class="border border-slate-400 pl-4"><?= $alumno["email"] ?></td>
                    <td class="border border-slate-400 pl-4"><?= $alumno["address"] ?></td>
                    <td class="border border-slate-400 pl-4"><?= $alumno["birthday"] ?></td>
