...
<div class="w-full flex h-screen">
        ...
        <div class="w-5/6 flex flex-col">
            ...
            <div class="bg-[#F5F6FA] h-screen">
                ...
                <h1 class="text-3xl font-medium">Lista de Maestros</h1>
                <div><a href="/dashboard"><span class="text-[#5093f7]">Home </span></a><span>/ Maestros</span></div>
                </div>
                <div class=" rounded shadow border-gray-500 py-4 bg-[#FFFFFF] mt-6 w-full">
                    <div class="border-b px-4 flex justify-between pb-4"><span>Informacion de Maestros</span><a href="/maestros/create" class="bg-[#0579F2] rounded py-1 px-3 text-white text-l">Agregar Maestro</a></div>
                    <div class="px-4 mt-6 mb-6 w-full">
                    <table class="border-collapse border border-slate-500 w-full">
                        <thead>
                            <tr>
                                <th class="border border-slate-600 py-2 text-left pl-4">#</th>
                                <th class="border border-slate-600 text-left pl-4">Nombre</th>
                                <th class="border border-slate-600 text-left pl-4">Email</th>
                                <th class="border border-slate-600 text-left pl-4">Direccion</th>
                                <th class="border border-slate-600 text-left pl-4">Fec. de Nacimiento</th>
                                <th class="border border-slate-600 text-left pl-4">Clase Asignada</th>
            ...
            ?>
                <tr class="bg-white odd:bg-[#F2F2F2] ">
                    <td class="border border-slate-400 pl-4 py-2"><?= $teacher["id"] ?></td>
                    <td class="border border-slate-400 pl-4"><?= $teacher["name"] ?></td>
                    <td class="border border-slate-400 pl-4"><?= $teacher["email"] ?></td>
                    <td class="border border-slate-400 pl-4"><?= $teacher["address"] ?></td>
                    <td class="border border-slate-400 pl-4"><?= $teacher["birthday"] ?></td>
